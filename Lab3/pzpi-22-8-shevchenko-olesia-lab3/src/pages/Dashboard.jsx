  ...
  return (
    <div className="dashboard-container">
      ...
      <section className="dashboard-section">
        <h2 className="section-heading">{t("dashboard.latestObservations")}</h2>
        {observations.length === 0 ? (
          <p className="empty-text">{t("dashboard.noObservations")}</p>
        ) : (
      ...
      {/* Subscribed Events */}
      <section>
        <h2 className="section-heading">{t("dashboard.subscribedEvents")}</h2>
        {subscribedEvents.length === 0 ? (
          <p className="empty-text">{t("dashboard.noSubscribedEvents")}</p>
        ) : (
