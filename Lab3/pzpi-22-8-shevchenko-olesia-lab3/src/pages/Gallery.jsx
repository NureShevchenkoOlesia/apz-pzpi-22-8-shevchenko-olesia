...
export default function Gallery() {
    ...
    return (
        <div className="gallery-container">
            <h1 className="text-3xl font-bold mb-2 text-center">{t("gallery.title")}</h1>
            <p className="text-base truncate mb-10">{t("gallery.subtitle")}</p>
                        ...
                        <div className="flex flex-col text-left w-full">
                            <div>
                                ...
                                <div className="text-sm text-white/60 mb-4">
                                    <h4 className="font-semibold mb-2">{t("gallery.calibration")}</h4>
                                ...
                                <div className="text-sm text-white/60">
                                    ...
                                    >
                                        {showObjects
                                            ? t("gallery.hideObjects")
                                            : t("gallery.showObjects", { count: selectedObservation.objects_in_field?.length || 0 })}
                                    </h4>
                                    {showObjects && (
